            ...
            <div>
              ...
              <div className="flex gap-3 flex-wrap">
                <button
                  ...
                  disabled={paying}
                  className="flex items-center gap-2 px-6 py-3 bg-black dark:bg-white dark:text-black text-white text-sm rounded-xl hover:bg-red-600 dark:hover:bg-red-600 dark:hover:text-white transition-colors disabled:opacity-50"
                >
      ...
      <div className="container mx-auto px-4 md:px-8 pt-28 pb-20 max-w-3xl">
        ...
        {orders.length === 0 ? (
          <div className="text-center py-20">
            ...
            <button onClick={() => navigate('/cart')} className="px-8 py-3 bg-black dark:bg-white dark:text-black text-white text-sm uppercase tracking-widest rounded-xl hover:bg-red-600 transition-colors">
              Перейти в корзину
            </button>
          </div>
        ) : (
