          ...
          <>
            ...
            <div className="border-t border-neutral-200 dark:border-neutral-800 pt-6 flex items-center justify-between">
              ...
              <button
                onClick={checkout}
                disabled={ordering}
                className="px-10 py-4 bg-black dark:bg-white dark:text-black text-white text-sm uppercase tracking-widest rounded-xl hover:bg-pink-400 dark:hover:bg-pink-400 dark:hover:text-white transition-colors disabled:opacity-50"
              >
