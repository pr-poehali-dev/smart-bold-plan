      ...
      <div className="container mx-auto px-4 md:px-8 pt-36 md:pt-44 pb-20 max-w-3xl">
        ...
        {items.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-neutral-400 text-lg mb-6">{t('Корзина пуста')}</p>
            <button
          ...
          <>
                ...
                <div key={item.id} className="p-5 border border-neutral-200 dark:border-neutral-800 rounded-2xl bg-white dark:bg-neutral-900">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {item.description && (
                        <p className="text-sm text-neutral-400 mt-0.5 truncate">{t(item.description)}</p>
                      )}
            ...
            <div className="border border-neutral-200 dark:border-neutral-800 rounded-2xl p-5">
              <div className="flex items-center justify-between mb-4">
                <span className="text-neutral-500 dark:text-neutral-400">{t('Итого')}</span>
              ...
              >
                {ordering ? t('Оформляем...') : t('Оформить заказ')}
              </button>
            </div>
          </>
        )}
