      ...
      <div className="container mx-auto px-4 md:px-8 pt-28 pb-20 max-w-xl">
        ...
        <form onSubmit={save} className="space-y-4 mb-10">
          ...
          <button
            type="submit"
            disabled={saving}
            className="w-full py-4 bg-black dark:bg-white dark:text-black text-white text-sm uppercase tracking-widest rounded-xl hover:bg-red-600 dark:hover:bg-red-600 dark:hover:text-white transition-colors disabled:opacity-50"
          >
        ...
        <button onClick={doLogout} className="flex items-center gap-2 text-sm text-neutral-400 hover:text-red-500 transition-colors">
